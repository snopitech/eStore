    ...
    <div className="min-h-screen bg-gray-100 py-12">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="flex gap-4">
          <Link to="/" className="flex-1 bg-blue-600 text-white py-3 rounded-md text-center font-semibold hover:bg-blue-700">
            Continue Shopping
          </Link>
          <Link to="/order-history" className="flex-1 border border-blue-600 text-blue-600 py-3 rounded-md text-center font-semibold hover:bg-blue-50">
            View All Orders
          </Link>
        </div>
      </div>
