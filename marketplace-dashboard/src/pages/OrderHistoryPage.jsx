            ...
            {orders.map((order) => (
              <div key={order.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    {order.items?.map((item, idx) => (
                      <div key={idx} className="flex justify-between items-center border-b pb-4 last:border-0">
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">by {item.storeName}</div>
                  ...
                  {/* Order Summary */}
                  <div className="mt-6 pt-4 border-t flex flex-wrap justify-between items-center">
                    <div className="space-y-1">
                      <div className="text-sm text-gray-500">
                        Shipping to: {order.shippingAddress ? JSON.parse(order.shippingAddress).address : 'N/A'}
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm text-gray-500">
                      ...
                      <div className="text-xl font-bold mt-1">Total: ${order.totalAmount}</div>
                    </div>
                  </div>
